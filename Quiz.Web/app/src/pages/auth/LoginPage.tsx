...
export function LoginPage() {
    ...
    return (
        <AuthShell
            title="Conectează-te"
            subtitle="Intră în cont pentru a continua quizurile și testele live."
        >
            <form onSubmit={onSubmit} className="space-y-4">
                ...
                <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm text-slate-600 dark:bg-slate-950/30 dark:text-slate-400">
                    Dacă nu mai ai acces la cont, contactează administratorul platformei pentru resetarea parolei.
                </div>
